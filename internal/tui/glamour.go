...
func RenderFlagGlamour(flag *models.FeatureFlagDefinition, instances []models.FeatureFlagInstance) error {
...
func buildFlagMarkdown(flag *models.FeatureFlagDefinition, instances []models.FeatureFlagInstance) string {
...
func renderVariables(m *markdown.Markdown, vars models.Variables) {
